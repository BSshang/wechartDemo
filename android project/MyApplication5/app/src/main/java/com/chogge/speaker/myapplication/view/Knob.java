...
import com.chogge.speaker.myapplication.R;
import com.chogge.speaker.myapplication.facebook.rebound.SimpleSpringListener;
...
import com.chogge.speaker.myapplication.utils.MyUtils;
...
public class Knob extends View {
    ...
    BalloonPopup.BalloonAnimation getBalloonAnimation() {
        ...
        if (this.balloonValuesAnimation == 1) {
            return BalloonPopup.BalloonAnimation.fade_and_scale;
        }
        if (this.balloonValuesAnimation == 2 && this.balloonValuesSlightlyTransparent) {
            return BalloonPopup.BalloonAnimation.fade75;
        }
        return BalloonPopup.BalloonAnimation.fade;
    }
